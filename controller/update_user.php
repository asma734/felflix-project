...
if(!isset($_SESSION['user'])){header('Location: '.$base.'/view/login.php');exit;}
$isAdmin=$_SESSION['user']['role']==='admin';
$eid=(int)($_POST['id']??0);
if(!$isAdmin&&$eid!==(int)$_SESSION['user']['id']){header('Location: '.$base.'/view/index.php');exit;}
...
header('Location: '.$base.($isAdmin?'/view/admin.php?tab=users':'/view/profile.php'));exit;
