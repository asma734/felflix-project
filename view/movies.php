<?php
// ============================================================
//  VUE : Aflam m7ar7ra (Premium Movie Section)
// ============================================================
session_start();
...
$filters = [
    'q'           => trim($_GET['q'] ?? ''),
    'type'        => 'movie', // Fixé pour cette page
...
<div class="wrap" style="padding-top:120px; padding-bottom:60px">
    ...
    <div class="search-header-premium" style="margin-bottom: 40px;">
        <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 10px;">
            ...
            <h1 style="font-family: 'Space Grotesk', sans-serif; font-weight: 800; font-size: 3.5rem; margin: 0; color: #fff; letter-spacing: -1px;">Aflam <span style="color: #f5a623;">m7ar7ra</span></h1>
        </div>
        <p style="color: var(--muted); font-size: 1rem; margin-left: 5px;"><?= number_format($total, 0, '.', ' ') ?> films trouvés dans cette catégorie</p>
    </div>
    ...
    <div class="grid">
        <?php if(empty($results)): ?>
            <div class="empty-s" style="grid-column: 1/-1;">
                ...
                <a href="movies.php" class="btn-ghost">Réinitialiser</a>
            </div>
        <?php else: ?>
